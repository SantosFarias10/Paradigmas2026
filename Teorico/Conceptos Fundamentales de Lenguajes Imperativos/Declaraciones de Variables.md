...
* **l-valor**: Es la ubicacion en memoria (o sea la direccion de memoria).
* **r-valor**: Es el valor que se guarda en la ubicacion de memoria identificada por el l-valor.
* **Identificador**: Es el nombre de la variable en el texto del programa.
